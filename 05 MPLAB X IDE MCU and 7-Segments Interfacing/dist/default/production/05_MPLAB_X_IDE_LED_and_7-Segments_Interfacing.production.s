...
TOSU equ 0FFFh ;# 
	...
	FNCALL	_main,_print_number_seven_seg
	FNCALL	_SYSTEM_Initialize,_OSCILLATOR_Initialize
	FNCALL	_SYSTEM_Initialize,_PIN_MANAGER_Initialize
	FNROOT	_main
	global	_common_anode_seg_table
psect	idataCOMRAM,class=CODE,space=0,delta=1,noexec
global __pidataCOMRAM
__pidataCOMRAM:
	file	"ECU Layer/seven_seg.c"
	line	23

;initializer for _common_cathode_seg_table
	db	low(0C0h)
	db	low(0F9h)
	db	low(0A4h)
	db	low(0B0h)
...
;initializer for _common_anode_seg_table
	db	low(0C0h)
	db	low(0F9h)
	db	low(0A4h)
	db	low(0B0h)
...
__CFG_EBTRB$OFF equ 0x0
	file	"dist/default/production\05_MPLAB_X_IDE_LED_and_7-Segments_Interfacing.production.s"
	line	#
...
__pdataCOMRAM:
	file	"ECU Layer/seven_seg.c"
	line	23
	global	_common_cathode_seg_table
	global	_common_cathode_seg_table
_common_cathode_seg_table:
       ds      10
psect	dataCOMRAM
	file	"ECU Layer/seven_seg.c"
	line	10
	global	_common_anode_seg_table
_common_anode_seg_table:
       ds      10
	file	"dist/default/production\05_MPLAB_X_IDE_LED_and_7-Segments_Interfacing.production.s"
	line	#
psect	cinit
...
??_OSCILLATOR_Initialize:	; 1 bytes @ 0x0
?_print_number_seven_seg:	; 1 bytes @ 0x0
??_print_number_seven_seg:	; 1 bytes @ 0x0
...
?_main:	; 1 bytes @ 0x0
	ds   1
	global	print_number_seven_seg@number
print_number_seven_seg@number:	; 1 bytes @ 0x1
	ds   1
??_main:	; 1 bytes @ 0x2
	ds   2
;!
...
l793:
;main.c: 13:     {;main.c: 15:         for(counter = 0; counter <= 9; counter++){
	movlw	low(0)
...
l799:
	movf	((c:_counter))^00h,c,w	;volatile
	
	call	_print_number_seven_seg
	line	17
	
l801:
;main.c: 17:             _delay((unsigned long)((500)*(8000000/4000.0)));
	opt asmopt_push
opt asmopt_off
movlw  6
...
GLOBAL	__end_of_main
	__end_of_main:
	signat	_main,89
	global	_print_number_seven_seg

;; *************** function _print_number_seven_seg *****************
;; Defined at:
;;		line 36 in file "ECU Layer/seven_seg.c"
;; Parameters:    Size  Location     Type
...
psect	text1
	file	"ECU Layer/seven_seg.c"
	line	36
	global	__size_of_print_number_seven_seg
	__size_of_print_number_seven_seg	equ	__end_of_print_number_seven_seg-_print_number_seven_seg
	
_print_number_seven_seg:
;incstack = 0
	opt	callstack 30
;print_number_seven_seg@number stored from wreg
	movwf	((c:print_number_seven_seg@number))^00h,c
	line	37
...
l771:
;ECU Layer/seven_seg.c: 38:     if(number > 9){
		movlw	0Ah-1
	cpfsgt	((c:print_number_seven_seg@number))^00h,c
	goto	u11
	goto	u10
...
l773:
;ECU Layer/seven_seg.c: 39:         return R_NOK;
	movlw	(0)&0ffh
	goto	l10
	line	42
	
l779:
;ECU Layer/seven_seg.c: 42:         PORTC = common_anode_seg_table[number];
	movlw	low(_common_anode_seg_table)
	addwf	((c:print_number_seven_seg@number))^00h,c,w
	movwf	c:fsr2l
	clrf	1+c:fsr2l
	movlw	high(_common_anode_seg_table)
	addwfc	1+c:fsr2l
	movf	indf2,w
...
l781:
;ECU Layer/seven_seg.c: 44:     return R_OK;
	movlw	(01h)&0ffh
	line	45
...
l10:
	return	;funcret
	opt callstack 0
GLOBAL	__end_of_print_number_seven_seg
	__end_of_print_number_seven_seg:
	signat	_print_number_seven_seg,4217
